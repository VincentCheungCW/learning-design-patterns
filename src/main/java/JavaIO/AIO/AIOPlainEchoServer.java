...
public class AIOPlainEchoServer {
        ...
        serverChannel.accept(null,
                new CompletionHandler<AsynchronousSocketChannel, Object>() {
                    ...
                    public void completed(final AsynchronousSocketChannel channel,
                        ...
                        // 在channel里植入一个读操作EchoCompletionHandler，一旦buffer
                        // 有数据写入，EchoCompletionHandler 便会被唤醒
    ...
    private final class EchoCompletionHandler implements CompletionHandler<Integer,
            ByteBuffer> {
                    ...
                    new CompletionHandler<Integer, ByteBuffer>() {
                        ...
                        public void completed(Integer result, ByteBuffer buffer) {
                            if (buffer.hasRemaining()) {
                                ...
                                channel.read(buffer, buffer, EchoCompletionHandler
                                        .this);
                            }
                        }
